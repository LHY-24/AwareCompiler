...
def process_csv_file(csv_path: str, output_dir: str) -> None:
    ...
    # Process the data
    processed_data = []
    base_path = "<repo_root>/examples/data_preprocess/llvmir_datasets/"
...
def main():
    ...
    # TODO: 修改路径
    csv_path = "<repo_root>/examples/data_preprocess/optimal_passsequence.csv"
    output_dir = "<repo_root>/knowledge_base"
